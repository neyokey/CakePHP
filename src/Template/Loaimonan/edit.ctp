...
<!--breadcrumbs-->
  <div id="content-header">
    ...
    <a href="<?php echo $this->Url->build('/loaimonan', true);?>" title="Ứng viên" > Loại món ăn</a>
    <a href="" title="Create new city" class="current"> Cập nhật loại món ăn</a>
    </div>
  </div>
...
<div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Cập nhật loại món ăn</h5>
        </div>
        <div class="widget-content nopadding ">
            <?= $this->Form->create($loaimonan, ['class' => 'form-horizontal', 'enctype' => 'multipart/form-data' ,'type' => 'file']) ?>
