...
<!--breadcrumbs-->
  <div id="content-header">
    ...
    <a href="<?php echo $this->Url->build('/loaibantin', true);?>" title="Ứng viên" > Loại bản tin</a>
    <a href="" title="Create new city" class="current"> Cập nhật loại bản tin</a>
    </div>
  </div>
  ...
  <div class="container-fluid">
    ...
    <div class="widget-box">
      <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
        <h5>Cập nhật loại bản tin</h5>
      </div>
      <div class="widget-content nopadding ">
          <?= $this->Form->create($loaibantin, ['class' => 'form-horizontal', 'enctype' => 'multipart/form-data' ,'type' => 'file']) ?>
