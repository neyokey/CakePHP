...
<!--breadcrumbs-->
  <div id="content-header">
    ...
    <a href="<?php echo $this->Url->build('/bantin', true);?>" title="Ứng viên" > Bản tin</a>
    <a href="" class="current"> Thêm bản tin</a>
    </div>
  </div>
        ...
        <div class="widget-content nopadding ">
          ...
          <input type="hidden" name="_token" value="J5fxrY2jv3eWDWEYo4iJ8v4prF4TTktA5axJIQLS">
            ...
            <div class="control-group ">
              ...
              <div class="controls">
                <?php
                    echo $this->Form->control('content', ['class' => 'textarea_editor span6', 'style' => 'min-height: 200px', 'id'=>'editor', 'placeholder' => 'Nội dung', 'label' => false]);
                ?>
              </div>
            </div>
            <div class="control-group ">
